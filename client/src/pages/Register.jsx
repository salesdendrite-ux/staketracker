    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-brand-800 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <h2 className="font-display text-4xl text-white mb-4 leading-tight">Start tracking stakeholder movements today.</h2>
          <p className="text-brand-300 text-lg leading-relaxed">Set up your company watchlist, connect scraping sources, and never miss a leadership change again.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-500 text-sm mb-8">Get started with StakeTracker</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Full name</label>
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="input-field" placeholder="Jane Smith" required />
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} className="input-field pr-10" placeholder="Min. 6 characters" required minLength={6} />
